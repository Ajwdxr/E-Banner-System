						...
						<div class="ti-content">
							...
							<div class="ti-text">
							 ...
							 <table width="105%" border="0" align="center" cellpadding="0" cellspacing="0">
							  ...
							  <tr>
								<td>
								<form action="db_add_product.php" method="post" name="add_product">
								<table width="100%" border="5" align="center">
								 <tr>
									<td width="16%"><font color="white">Banner Size</font></td>  
									<td width="84%"><input type="hidden" name="bannerSize" size="50" placeholder="Banner Size" /><font color="white">Fixed Size (15ft x 14ft)</font></td>  
								  </tr>  
								  <tr>
									<td width="16%"><font color="white">Banner Description</font></td>
									<td><input type="text" name="bannerDesc" size="50" placeholder="Banner Description"/></td>
								  </tr>
								  <tr>
									<td width="16%"><font color="White">Banner Location</font></td>  
									<td width="84%"><input name="bannerLocation" type="radio" value="Pintu Masuk Pertama" /><font color="white">Pintu Masuk Pertama</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		
									<input name="bannerLocation" type="radio" value="Dataran Ilmu" /><font color="white">Dataran Ilmu</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									
									<input name="bannerLocation" type="radio" value="Persimpangan DIDE" /><font color="white">Persimpangan DIDE</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									
									<input name="bannerLocation" type="radio" value="Pintu Masuk Kedua" /><font color="white">Pintu Masuk Kedua</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									
									</td>
								  <tr>
									<td width="16%"><font color="white">Banner Apply Date</font></td>  
									<td width="84%"><input type="date" name="bannerApplyDate" size="50"  /></td>  
								  </tr>
								  <tr>
									<td width="16%"><font color="White">Banner Event Date</font></td>  
									<td width="84%"><input type="date" name="bannerEventDate" size="50"  /></td>  
								  </tr>
								  
								  <td><font color="white">Picture:</font></td>
								  <td>
									  <input type="file" name="file" id="file"/><font color="white">.jpg/.png/.jpeg file only</font>
									</td>
								  </tr>  
								  <!-- <tr>
									<td width="16%"><font color="white">Banner Status</font></td>  
									<td width="84%"><input type="text" name="bannerStatus" size="50" placeholder="Pending/Successful/Rejected" /></td>  
								  </tr>-->
								   <!-- <tr>
									<td width="16%"><font color="white">Banner Comment</font></td>  
									<td width="84%"><input type="text" name="bannerComment" size="50" placeholder="Comment" /></td>  
								  </tr>-->
								  
								  <tr> 
									<td colspan="2"><input type="submit" name="submit" value=" Save " />
									<input type="button" name="cancel" value=" Cancel " onclick="location.href='view_product.php?site=03'" /></td>
								  </tr>
								</table>
								</form>
								</td>
